...
使用命令行批量安装 Windows 软件，同类命令行应用有：[Scoop](https://scoop.sh/) 、winget

这节课，我们学习使用 [Chocolatey](https://community.chocolatey.org/packages)。
...
> 你可以访问 https://community.chocolatey.org/packages 进行线上搜索可以安装的软件
...
choco install -y googlechrome firefox git vscode nvm

# 使用 nvm 安装 20.19.0 版本的 node 
nvm install 20.19.0 
# 使用 20.19.0 版本的 node
nvm use 20.19.0
```

> 注：可以查看 [nvm](/docs/npm%20和%20nvm%20的使用) 工具的使用
